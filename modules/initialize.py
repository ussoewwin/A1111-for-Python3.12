...
def imports():
    ...
    # Protobuf v6 compatibility shim for extensions still calling
    # MessageFactory.GetPrototype (removed in protobuf>=4).
    try:
        from google.protobuf import message_factory as _pb_message_factory  # type: ignore
        if hasattr(_pb_message_factory, "MessageFactory") and not hasattr(_pb_message_factory.MessageFactory, "GetPrototype"):
            def _compat_get_prototype(self, descriptor):  # noqa: ANN001
